...
import static com.vizzionnaire.server.controller.ControllerConstants.TENANT_PROFILE_ID_PARAM_DESCRIPTION;
import static com.vizzionnaire.server.controller.ControllerConstants.TENANT_PROFILE_INFO_SORT_PROPERTY_ALLOWABLE_VALUES;
import static com.vizzionnaire.server.controller.ControllerConstants.TENANT_PROFILE_SORT_PROPERTY_ALLOWABLE_VALUES;
import static com.vizzionnaire.server.controller.ControllerConstants.TENANT_PROFILE_TEXT_SEARCH_DESCRIPTION;
...
import com.vizzionnaire.server.service.entitiy.tenant.profile.TbTenantProfileService;
...
public class TenantProfileController extends BaseController {
    ...
    public TenantProfile getTenantProfileById(
            ...
            @PathVariable("tenantProfileId") String strTenantProfileId) throws VizzionnaireException {
    ...
    @ResponseBody
    public EntityInfo getDefaultTenantProfileInfo() throws VizzionnaireException {
        try {
    ...
    public TenantProfile saveTenantProfile(@ApiParam(value = "A JSON value representing the tenant profile.")
                                           @RequestBody TenantProfile tenantProfile) throws VizzionnaireException {
        try {
