package com.vizzionnaire.server.service.sms.twilio;

import com.twilio.http.TwilioRestClient;
import com.twilio.rest.api.v2010.account.Message;
import com.twilio.type.PhoneNumber;
import com.vizzionnaire.rule.engine.api.sms.exception.SmsException;
import com.vizzionnaire.rule.engine.api.sms.exception.SmsParseException;
import com.vizzionnaire.rule.engine.api.sms.exception.SmsSendException;
import com.vizzionnaire.server.common.data.StringUtils;
import com.vizzionnaire.server.common.data.sms.config.TwilioSmsProviderConfiguration;
import com.vizzionnaire.server.service.sms.AbstractSmsSender;
