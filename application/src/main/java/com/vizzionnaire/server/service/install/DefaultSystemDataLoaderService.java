...
import com.vizzionnaire.server.common.data.query.DynamicValueSourceType;
...
public class DefaultSystemDataLoaderService implements SystemDataLoaderService {
    ...
    public void initExecutor() {
        tsCallBackExecutor = Executors.newSingleThreadExecutor(VizzionnaireThreadFactory.forName("sys-loader-ts-callback"));
    }
    ...
    public void createSysAdmin() {
        createUser(Authority.SYS_ADMIN, null, null, "sysadmin@vizzionnaire.org", "sysadmin");
    }
    ...
    public void loadDemoData() throws Exception {
        ...
        createUser(Authority.TENANT_ADMIN, demoTenant.getId(), null, "tenant@vizzionnaire.org", "tenant");
        ...
        createUser(Authority.CUSTOMER_USER, demoTenant.getId(), customerA.getId(), "customer@vizzionnaire.org", CUSTOMER_CRED);
        createUser(Authority.CUSTOMER_USER, demoTenant.getId(), customerA.getId(), "customerA@vizzionnaire.org", CUSTOMER_CRED);
        createUser(Authority.CUSTOMER_USER, demoTenant.getId(), customerB.getId(), "customerB@vizzionnaire.org", CUSTOMER_CRED);
        createUser(Authority.CUSTOMER_USER, demoTenant.getId(), customerC.getId(), "customerC@vizzionnaire.org", CUSTOMER_CRED);
