...
import com.vizzionnaire.server.common.data.queue.ProcessingStrategyType;
import com.vizzionnaire.server.common.data.queue.Queue;
import com.vizzionnaire.server.common.data.queue.SubmitStrategy;
import com.vizzionnaire.server.common.data.queue.SubmitStrategyType;
...
import com.vizzionnaire.server.queue.settings.TbRuleEngineQueueConfiguration;
import com.vizzionnaire.server.service.install.sql.SqlDbHelper;
...
import static com.vizzionnaire.server.service.install.DatabaseHelper.ADDITIONAL_INFO;
import static com.vizzionnaire.server.service.install.DatabaseHelper.ASSIGNED_CUSTOMERS;
import static com.vizzionnaire.server.service.install.DatabaseHelper.CONFIGURATION;
import static com.vizzionnaire.server.service.install.DatabaseHelper.CUSTOMER_ID;
import static com.vizzionnaire.server.service.install.DatabaseHelper.DASHBOARD;
import static com.vizzionnaire.server.service.install.DatabaseHelper.END_TS;
import static com.vizzionnaire.server.service.install.DatabaseHelper.ENTITY_ID;
import static com.vizzionnaire.server.service.install.DatabaseHelper.ENTITY_TYPE;
import static com.vizzionnaire.server.service.install.DatabaseHelper.ENTITY_VIEW;
import static com.vizzionnaire.server.service.install.DatabaseHelper.ENTITY_VIEWS;
import static com.vizzionnaire.server.service.install.DatabaseHelper.ID;
import static com.vizzionnaire.server.service.install.DatabaseHelper.KEYS;
import static com.vizzionnaire.server.service.install.DatabaseHelper.NAME;
import static com.vizzionnaire.server.service.install.DatabaseHelper.SEARCH_TEXT;
import static com.vizzionnaire.server.service.install.DatabaseHelper.START_TS;
import static com.vizzionnaire.server.service.install.DatabaseHelper.TENANT_ID;
import static com.vizzionnaire.server.service.install.DatabaseHelper.TITLE;
import static com.vizzionnaire.server.service.install.DatabaseHelper.TYPE;
