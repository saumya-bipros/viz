...
import com.vizzionnaire.server.common.data.security.model.mfa.account.TotpTwoFaAccountConfig;
...
import com.vizzionnaire.server.common.data.security.model.mfa.provider.TotpTwoFaProviderConfig;
...
import com.vizzionnaire.server.service.security.auth.mfa.provider.impl.OtpBasedTwoFaProvider;
import com.vizzionnaire.server.service.security.auth.mfa.provider.impl.TotpTwoFaProvider;
...
public abstract class TwoFactorAuthConfigTest extends AbstractControllerTest {
    ...
    public void testSubmitTotpTwoFaAccountConfig_validationError() throws Exception {
        ...
        totpTwoFaAccountConfig.setAuthUrl("otpauth://totp/ThingsBoard%20(Tenant):tenant@vizzionnaire.org?issuer=ThingsBoard+%28Tenant%29&secret=FUNBIM3CXFNNGQR6ZIPVWHP65PPFWDII");
