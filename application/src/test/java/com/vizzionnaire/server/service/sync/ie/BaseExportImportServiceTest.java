...
import com.vizzionnaire.rule.engine.debug.TbMsgGeneratorNode;
import com.vizzionnaire.rule.engine.debug.TbMsgGeneratorNodeConfiguration;
import com.vizzionnaire.rule.engine.metadata.TbGetAttributesNodeConfiguration;
...
public abstract class BaseExportImportServiceTest extends AbstractControllerTest {
    ...
    protected RuleChain createRuleChain(TenantId tenantId, String name, EntityId originatorId) {
        ...
        ruleNode2.setType(com.vizzionnaire.rule.engine.metadata.TbGetAttributesNode.class.getName());
    ...
    protected RuleChain createRuleChain(TenantId tenantId, String name) {
        ...
        ruleNode1.setType(com.vizzionnaire.rule.engine.metadata.TbGetAttributesNode.class.getName());
        ruleNode1.setDebugMode(true);
