package com.vizzionnaire.server.transport.lwm2m.security;

import com.fasterxml.jackson.databind.node.ObjectNode;
import com.vizzionnaire.common.util.JacksonUtil;
import com.vizzionnaire.server.common.data.Device;
import com.vizzionnaire.server.common.data.device.credentials.lwm2m.LwM2MBootstrapClientCredentials;
import com.vizzionnaire.server.common.data.device.credentials.lwm2m.LwM2MClientCredential;
import com.vizzionnaire.server.common.data.device.credentials.lwm2m.LwM2MDeviceCredentials;
import com.vizzionnaire.server.common.data.device.credentials.lwm2m.LwM2MSecurityMode;
import com.vizzionnaire.server.common.data.device.credentials.lwm2m.NoSecBootstrapClientCredential;
import com.vizzionnaire.server.common.data.device.credentials.lwm2m.PSKBootstrapClientCredential;
import com.vizzionnaire.server.common.data.device.credentials.lwm2m.PSKClientCredential;
import com.vizzionnaire.server.common.data.device.credentials.lwm2m.RPKBootstrapClientCredential;
import com.vizzionnaire.server.common.data.device.credentials.lwm2m.X509BootstrapClientCredential;
import com.vizzionnaire.server.common.data.device.profile.Lwm2mDeviceProfileTransportConfiguration;
import com.vizzionnaire.server.common.data.device.profile.lwm2m.bootstrap.AbstractLwM2MBootstrapServerCredential;
import com.vizzionnaire.server.common.data.device.profile.lwm2m.bootstrap.LwM2MBootstrapServerCredential;
import com.vizzionnaire.server.common.data.device.profile.lwm2m.bootstrap.PSKLwM2MBootstrapServerCredential;
import com.vizzionnaire.server.common.data.device.profile.lwm2m.bootstrap.RPKLwM2MBootstrapServerCredential;
import com.vizzionnaire.server.common.data.device.profile.lwm2m.bootstrap.X509LwM2MBootstrapServerCredential;
...
import com.vizzionnaire.server.transport.lwm2m.AbstractLwM2MIntegrationTest;
import com.vizzionnaire.server.transport.lwm2m.Lwm2mTestHelper.LwM2MClientState;
import com.vizzionnaire.server.transport.lwm2m.Lwm2mTestHelper.LwM2MProfileBootstrapConfigType;
...
import static com.vizzionnaire.server.transport.lwm2m.Lwm2mTestHelper.OBJECT_ID_1;
import static com.vizzionnaire.server.transport.lwm2m.Lwm2mTestHelper.RESOURCE_ID_9;
