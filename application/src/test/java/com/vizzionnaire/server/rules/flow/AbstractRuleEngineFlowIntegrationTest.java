package com.vizzionnaire.server.rules.flow;
...
import com.vizzionnaire.server.controller.AbstractRuleEngineControllerTest;
...
public abstract class AbstractRuleEngineFlowIntegrationTest extends AbstractRuleEngineControllerTest {
    ...
    public void testTwoRuleChainsWithTwoRules() throws Exception {
        ...
        ruleNode12.setType(com.vizzionnaire.rule.engine.flow.TbRuleChainInputNode.class.getName());
