...
import com.vizzionnaire.server.dao.model.sql.DeviceEntity;
import com.vizzionnaire.server.dao.model.sql.DeviceInfoEntity;
...
public interface DeviceRepository extends JpaRepository<DeviceEntity, UUID>, ExportableEntityRepository<DeviceEntity> {
    ...
    @Query("SELECT new com.vizzionnaire.server.dao.model.sql.DeviceInfoEntity(d, c.title, c.additionalInfo, p.name) " +
            "FROM DeviceEntity d " +
