...
import com.vizzionnaire.server.dao.model.sql.EdgeEntity;
import com.vizzionnaire.server.dao.model.sql.EdgeInfoEntity;
...
public interface EdgeRepository extends JpaRepository<EdgeEntity, UUID> {
    ...
    @Query("SELECT new com.vizzionnaire.server.dao.model.sql.EdgeInfoEntity(d, c.title, c.additionalInfo) " +
            "FROM EdgeEntity d " +
    ...
    @Query("SELECT new com.vizzionnaire.server.dao.model.sql.EdgeInfoEntity(a, c.title, c.additionalInfo) " +
            "FROM EdgeEntity a " +
