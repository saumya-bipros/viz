...
import com.vizzionnaire.server.dao.model.sql.WidgetTypeEntity;
import com.vizzionnaire.server.dao.model.sql.WidgetTypeInfoEntity;
...
public interface WidgetTypeRepository extends JpaRepository<WidgetTypeDetailsEntity, UUID> {
    ...
    @Query("SELECT new com.vizzionnaire.server.dao.model.sql.WidgetTypeInfoEntity(wtd) FROM WidgetTypeDetailsEntity wtd " +
