...
import com.vizzionnaire.server.common.data.rule.RuleNodeUpdateResult;
...
import static com.vizzionnaire.server.common.data.DataConstants.TENANT;
...
public class BaseRuleChainService extends AbstractEntityService implements RuleChainService {
    ...
    public static final String TB_RULE_CHAIN_INPUT_NODE = "com.vizzionnaire.rule.engine.flow.TbRuleChainInputNode";
    @Autowired
        ...
        if (nodes != null) {
            ...
            if (ruleChainMetaData.getRuleChainConnections() != null) {
                for (RuleChainConnectionInfo nodeToRuleChainConnection : ruleChainMetaData.getRuleChainConnections()) {
                    ...
                    targetNode.setType("com.vizzionnaire.rule.engine.flow.TbRuleChainInputNode");
