...
import com.vizzionnaire.server.dao.model.sql.AlarmEntity;
import com.vizzionnaire.server.dao.model.sql.AlarmInfoEntity;
...
public interface AlarmRepository extends JpaRepository<AlarmEntity, UUID> {
    ...
    @Query(value = "SELECT new com.vizzionnaire.server.dao.model.sql.AlarmInfoEntity(a) FROM AlarmEntity a " +
