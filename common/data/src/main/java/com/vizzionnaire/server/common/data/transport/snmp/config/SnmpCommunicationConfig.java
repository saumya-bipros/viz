...
import com.vizzionnaire.server.common.data.transport.snmp.config.impl.ClientAttributesQueryingSnmpCommunicationConfig;
import com.vizzionnaire.server.common.data.transport.snmp.config.impl.SharedAttributesSettingSnmpCommunicationConfig;
import com.vizzionnaire.server.common.data.transport.snmp.config.impl.TelemetryQueryingSnmpCommunicationConfig;
import com.vizzionnaire.server.common.data.transport.snmp.config.impl.ToDeviceRpcRequestSnmpCommunicationConfig;
