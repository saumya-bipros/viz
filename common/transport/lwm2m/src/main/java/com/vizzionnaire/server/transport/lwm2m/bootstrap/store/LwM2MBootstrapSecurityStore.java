package com.vizzionnaire.server.transport.lwm2m.bootstrap.store;
...
import com.vizzionnaire.server.transport.lwm2m.secure.LwM2mCredentialsSecurityInfoValidator;
import com.vizzionnaire.server.transport.lwm2m.secure.TbLwM2MSecurityInfo;
...
import com.vizzionnaire.server.transport.lwm2m.server.client.LwM2MAuthException;

import static com.vizzionnaire.server.transport.lwm2m.server.uplink.LwM2mTypeServer.BOOTSTRAP;
    ...
    private LwM2MBootstrapConfig getParametersBootstrap(TbLwM2MSecurityInfo store) {
        ...
        if (lwM2MBootstrapConfig != null) {
            ...
            if (this.getValidatedSecurityMode(lwM2MBootstrapConfig)) {
                ...
                helper.sendParametersOnVizzionnaireTelemetry(helper.getKvStringtoVizzionnaire(LOG_LWM2M_TELEMETRY, logMsg), sessionInfo);
                return null;
            }
        }
