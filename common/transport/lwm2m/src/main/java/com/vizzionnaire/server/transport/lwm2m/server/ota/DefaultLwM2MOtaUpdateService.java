...
import com.vizzionnaire.server.common.data.ota.OtaPackageKey;
import com.vizzionnaire.server.common.data.ota.OtaPackageType;
import com.vizzionnaire.server.common.data.ota.OtaPackageUpdateStatus;
...
import com.vizzionnaire.server.transport.lwm2m.server.ota.firmware.FirmwareDeliveryMethod;
import com.vizzionnaire.server.transport.lwm2m.server.ota.firmware.FirmwareUpdateResult;
import com.vizzionnaire.server.transport.lwm2m.server.ota.firmware.FirmwareUpdateState;
import com.vizzionnaire.server.transport.lwm2m.server.ota.firmware.LwM2MClientFwOtaInfo;
import com.vizzionnaire.server.transport.lwm2m.server.ota.firmware.LwM2MFirmwareUpdateStrategy;
import com.vizzionnaire.server.transport.lwm2m.server.ota.software.LwM2MClientSwOtaInfo;
import com.vizzionnaire.server.transport.lwm2m.server.ota.software.LwM2MSoftwareUpdateStrategy;
import com.vizzionnaire.server.transport.lwm2m.server.ota.software.SoftwareUpdateResult;
import com.vizzionnaire.server.transport.lwm2m.server.ota.software.SoftwareUpdateState;
import com.vizzionnaire.server.transport.lwm2m.server.store.TbLwM2MClientOtaInfoStore;
...
import static com.vizzionnaire.server.common.data.ota.OtaPackageKey.STATE;
import static com.vizzionnaire.server.common.data.ota.OtaPackageUpdateStatus.DOWNLOADED;
import static com.vizzionnaire.server.common.data.ota.OtaPackageUpdateStatus.DOWNLOADING;
import static com.vizzionnaire.server.common.data.ota.OtaPackageUpdateStatus.FAILED;
import static com.vizzionnaire.server.common.data.ota.OtaPackageUpdateStatus.UPDATED;
import static com.vizzionnaire.server.common.data.ota.OtaPackageUpdateStatus.UPDATING;
import static com.vizzionnaire.server.common.data.ota.OtaPackageUpdateStatus.VERIFIED;
import static com.vizzionnaire.server.common.data.ota.OtaPackageUtil.getAttributeKey;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.firmware.FirmwareUpdateResult.UPDATE_SUCCESSFULLY;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.software.SoftwareUpdateResult.NOT_ENOUGH_STORAGE;
...
public class DefaultLwM2MOtaUpdateService extends LwM2MExecutorAwareService implements LwM2MOtaUpdateService {
    ...
    private void sendStateUpdateToTelemetry(LwM2mClient client, LwM2MClientOtaInfo<?, ?, ?> fwInfo, OtaPackageUpdateStatus status, String log) {
        ...
        result.add(kvProto.build());
        helper.sendParametersOnVizzionnaireTelemetry(result, client.getSession(), client.getKeyTsLatestMap());
    }
