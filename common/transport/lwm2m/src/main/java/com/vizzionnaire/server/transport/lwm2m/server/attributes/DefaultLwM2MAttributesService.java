package com.vizzionnaire.server.transport.lwm2m.server.attributes;
...
import static com.vizzionnaire.server.transport.lwm2m.server.LwM2mTransportServerHelper.getValueFromKvProto;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FIRMWARE_TAG;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FIRMWARE_TITLE;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FIRMWARE_URL;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FIRMWARE_VERSION;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.SOFTWARE_TAG;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.SOFTWARE_TITLE;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.SOFTWARE_URL;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.SOFTWARE_VERSION;
...
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.compareAttNameKeyOta;
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.convertMultiResourceValuesFromJson;
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.fromVersionedIdToObjectId;
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.valueEquals;
