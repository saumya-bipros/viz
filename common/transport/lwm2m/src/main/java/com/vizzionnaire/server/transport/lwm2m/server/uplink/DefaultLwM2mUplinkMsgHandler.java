package com.vizzionnaire.server.transport.lwm2m.server.uplink;
...
import com.vizzionnaire.server.common.data.device.profile.Lwm2mDeviceProfileTransportConfiguration;
...
import com.vizzionnaire.server.common.data.ota.OtaPackageUtil;
...
import com.vizzionnaire.server.transport.lwm2m.config.LwM2MTransportServerConfig;
import com.vizzionnaire.server.transport.lwm2m.server.LwM2mOtaConvert;
import com.vizzionnaire.server.transport.lwm2m.server.LwM2mTransportContext;
import com.vizzionnaire.server.transport.lwm2m.server.LwM2mTransportServerHelper;
import com.vizzionnaire.server.transport.lwm2m.server.LwM2mVersionedModelProvider;
import com.vizzionnaire.server.transport.lwm2m.server.attributes.LwM2MAttributesService;
import com.vizzionnaire.server.transport.lwm2m.server.client.LwM2MClientState;
import com.vizzionnaire.server.transport.lwm2m.server.client.LwM2MClientStateException;
...
import com.vizzionnaire.server.transport.lwm2m.server.client.ParametersAnalyzeResult;
import com.vizzionnaire.server.transport.lwm2m.server.client.ResultsAddKeyValueProto;
import com.vizzionnaire.server.transport.lwm2m.server.common.LwM2MExecutorAwareService;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.DownlinkRequestCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.LwM2mDownlinkMsgHandler;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MCancelObserveCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MCancelObserveRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MLatchCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MObserveCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MObserveRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MReadCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MReadRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MWriteAttributesCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MWriteAttributesRequest;
...
import com.vizzionnaire.server.transport.lwm2m.server.model.LwM2MModelConfigService;
import com.vizzionnaire.server.transport.lwm2m.server.ota.LwM2MOtaUpdateService;
import com.vizzionnaire.server.transport.lwm2m.server.session.LwM2MSessionManager;
import com.vizzionnaire.server.transport.lwm2m.server.store.TbLwM2MDtlsSessionStore;
import com.vizzionnaire.server.transport.lwm2m.server.store.TbLwM2mSecurityStore;
import com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil;
import com.vizzionnaire.server.transport.lwm2m.utils.LwM2mValueConverterImpl;
...
import static com.vizzionnaire.common.util.CollectionsUtil.diffSets;
import static com.vizzionnaire.server.common.data.lwm2m.LwM2mConstants.LWM2M_SEPARATOR_PATH;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FW_3_VER_ID;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FW_DELIVERY_METHOD;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FW_NAME_ID;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FW_RESULT_ID;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FW_STATE_ID;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.FW_VER_ID;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.SW_3_VER_ID;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.SW_NAME_ID;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.SW_RESULT_ID;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.SW_STATE_ID;
import static com.vizzionnaire.server.transport.lwm2m.server.ota.DefaultLwM2MOtaUpdateService.SW_VER_ID;
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.LOG_LWM2M_ERROR;
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.LOG_LWM2M_INFO;
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.LOG_LWM2M_WARN;
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.convertObjectIdToVersionedId;
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.convertOtaUpdateValueToString;
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.fromVersionedIdToObjectId;
