...
import static com.vizzionnaire.server.transport.lwm2m.server.store.util.LwM2MClientSerDes.deserialize;
import static com.vizzionnaire.server.transport.lwm2m.server.store.util.LwM2MClientSerDes.serialize;
