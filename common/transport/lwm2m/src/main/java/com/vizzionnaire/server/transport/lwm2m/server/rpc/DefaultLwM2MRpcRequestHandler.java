...
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MCancelAllObserveCallback;
...
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MCreateRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MCreateResponseCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MDeleteCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MDeleteRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MDiscoverAllRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MDiscoverCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MDiscoverRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MExecuteCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MExecuteRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MObserveAllRequest;
...
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MWriteReplaceRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MWriteResponseCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.TbLwM2MWriteUpdateRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.composite.TbLwM2MReadCompositeCallback;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.composite.TbLwM2MReadCompositeRequest;
import com.vizzionnaire.server.transport.lwm2m.server.downlink.composite.TbLwM2MWriteResponseCompositeCallback;
import com.vizzionnaire.server.transport.lwm2m.server.log.LwM2MTelemetryLogService;
import com.vizzionnaire.server.transport.lwm2m.server.rpc.composite.RpcReadCompositeRequest;
import com.vizzionnaire.server.transport.lwm2m.server.rpc.composite.RpcReadResponseCompositeCallback;
import com.vizzionnaire.server.transport.lwm2m.server.rpc.composite.RpcWriteCompositeRequest;
...
import static com.vizzionnaire.server.transport.lwm2m.utils.LwM2MTransportUtil.convertMultiResourceValuesFromRpcBody;
